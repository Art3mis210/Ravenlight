...
public class JaneSideMissionFour : SideMissions
{
    ...
    void MissionComplete()
    {
        ...
        if (gameManager.playerInventory.InventoryItems[9] < 10)
            gameManager.playerInventory.InventoryItems[9] = 10;
        if (gameManager.playerInventory.InventoryItems[21] < 10)
            gameManager.playerInventory.InventoryItems[21] = 10;
        this.enabled = false;
    }
}
