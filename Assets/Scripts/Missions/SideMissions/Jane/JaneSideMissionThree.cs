...
public class JaneSideMissionThree : SideMissions
{
    ...
    void MissionComplete()
    {
        ...
        if (gameManager.playerInventory.InventoryItems[9] < 8)
            gameManager.playerInventory.InventoryItems[9] = 8;
        if (gameManager.playerInventory.InventoryItems[21] < 8)
            gameManager.playerInventory.InventoryItems[21] = 8;
        this.enabled = false;
    }
}
