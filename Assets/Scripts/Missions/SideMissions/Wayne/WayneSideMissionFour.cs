...
public class WayneSideMissionFour : SideMissions
{
    ...
    void MissionComplete()
    {
        ...
        if (gameManager.playerInventory.InventoryItems[5] < 1000)
            gameManager.playerInventory.InventoryItems[5] = 1000;
        if (gameManager.playerInventory.InventoryItems[7] < 1000)
            gameManager.playerInventory.InventoryItems[7] = 1000;
        this.enabled = false;
    }
}
