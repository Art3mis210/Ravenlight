...
public class WayneSideMissionTwo : SideMissions
{
    ...
    void MissionComplete()
    {
        ...
        if (gameManager.playerInventory.InventoryItems[5] < 700)
            gameManager.playerInventory.InventoryItems[5] = 700;
        if (gameManager.playerInventory.InventoryItems[7] < 700)
            gameManager.playerInventory.InventoryItems[7] = 700;
        this.enabled = false;
    }
}
