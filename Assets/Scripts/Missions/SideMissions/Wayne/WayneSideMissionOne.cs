...
public class WayneSideMissionOne : SideMissions
{
    ...
    void MissionComplete()
    {
        ...
        if (gameManager.playerInventory.InventoryItems[5] < 600)
            gameManager.playerInventory.InventoryItems[5] = 600;
        if (gameManager.playerInventory.InventoryItems[7] < 600)
            gameManager.playerInventory.InventoryItems[7] = 600;
        this.enabled = false;
    }
}
